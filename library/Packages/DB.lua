...
function DB.addChildCategory(nodeid, category)
end
...
function DB.addHandler(nodepath, event, callback)
end
...
function DB.addHolder(sourcenode, username, owner)
end
...
function DB.convertCampaign(ruleset)
end
...
function DB.copyNode(sourcenodeid, destnodeid)
end
...
function DB.createChild(sourcenode, name, type)
end
...
function DB.createNode(nodeid, type)
end
...
function DB.deleteChild(sourcenode, name)
end
...
function DB.deleteChildren(sourcenode, subpath)
end

--- This function deletes a data base node.
--- @param nodeid string|databasenode Data node identifier path (or databasenode object)
function DB.deleteNode(nodeid)
end
...
function DB.export(filename, targetnode, rewrite, listexport)
end
...
function DB.getCategory(nodeid)
end
...
function DB.getChild(sourcenode, name)
end
...
function DB.getChildCategories(nodeid)
end
...
function DB.getChildCount(sourcenode, subpath)
end
...
function DB.getChildList(sourcenode, subpath)
end
...
function DB.getChildren(sourcenode, subpath)
end
...
--- @return table #The child nodes are returned as databasenode objects in a table with keys corresponding to the names of the child nodes. If the database node does not exist, an empty table is returned.
function DB.getChildrenGlobal(source, sourcepath)
end
...
function DB.getDefaultChildCategory(nodeid, category)
end
...
function DB.getHolders(sourcenode)
end
...
function DB.getImportRulesetVersion()
end
...
function DB.getModule(sourcenode)
end
...
function DB.getParent(sourcenode)
end
...
--- Database paths are of the form: `[node].(...).[node][@Module Name]` where there can be any number of valid XML tag names concatenated by periods to form the main path and the at symbol and module name is optional.
...
function DB.getPath(node, value)
end
...
--- @return table #A table containing the major version number of each ruleset layer, where the key is the name of the ruleset layer.
--- @return table #A table containing the minor version number of each ruleset layer, where the key is the name of the ruleset layer.
function DB.getRulesetVersion(sourcenode)
end
...
function DB.getText(sourcenode, subpath, default)
end
...
function DB.getValue(sourcenode, subpath, default)
end
...
--- @return number #The major version number
--- @return number #The minor version number
function DB.getVersion(sourcenode)
end
...
function DB.import(filename, targetnode, listchildname)
end
...
function DB.isEmpty(sourcenode)
end
...
function DB.isIntact(sourcenode)
end
...
function DB.isReadOnly(sourcenode)
end
...
function DB.isStatic(sourcenode)
end
...
--- @param source databasenode A databasenode object reference identifying the node causing the event
function DB.onIntegrityChange(source)
end
...
--- ###This function will only work if running as a host.
--- @param sourcenode string|databasenode A data node identifier path (or a databasenode object) representing the target node
function DB.removeAllHolders(sourcenode)
end
...
function DB.removeChildCategory(nodeid, category)
end
...
function DB.removeHandler(nodepath, event, callback)
end
...
function DB.removeHolder(sourcenode, username)
end
...
function DB.setCategory(nodeid, category)
end
...
function DB.setDefaultChildCategory(nodeid, category)
end
...
function DB.setOwner(nodeid, owner)
end
...
function DB.setPublic(nodeid, value)
end
...
function DB.setStatic(sourcenode, state)
end
...
function DB.setValue(sourcenode, subpath, type, value)
end
...
function DB.updateChildCategory(nodeid, source_category, target_category)
end

--- Sets the version number value of the campaign database to the current FG and ruleset versions.
function DB.updateVersion()
end
