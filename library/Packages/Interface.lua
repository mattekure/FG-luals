...
function Interface.dialogFileOpen(callback, filter, directory, multiselect)
end
...
function Interface.dialogFileSave(callback, filter, directory)
end
...
function Interface.dialogMessage(callback, dialogtext, title, type)
end

---Cancel any message dialogs.
function Interface.dialogMessageClose()
end
...
function Interface.getRulesetInfo(lookupname)
end
...
function Interface.getString(id)
end
...
function Interface.getWindows(classname)
end
...
function Interface.isFont(fontname)
end
...
function Interface.isFrame(framename)
end
...
function Interface.isFullScreen()
end
...
function Interface.isIcon(iconname)
end
...
function Interface.onHotkeyActivated(dragdata)
end
...
function Interface.onHotkeyDrop(dragdata)
end
...
function Interface.onWindowClosed(window)
end
...
function Interface.onWindowOpened(window)
end
...
function Interface.openCampaignFolder(relative)
end
...
function Interface.openDataFolder(relative)
end
...
function Interface.openRadialMenu()
end
...
function Interface.openWindow(windowclass, datasource)
end
...
function Interface.openURL(url, callback)
end
...
function Interface.requestNewClientWindow(windowclass, rootnode)
end
...
---All the color components are specified as strings in the form "BBGGRR", where the characters are hexadecimal digits specifying the red, green and blue color channels in the range 0 .. 255. The colors will be modulated with the pixel values in the bitmaps defining the interface.
...
---@param systemcolor string The color used to render system interface elements
---@param windowcolor string The color used to render window frame interface elements
---@param controlcolor string The color used to render control elements
---@param contentcolor string The color used to render user specified content interface elements. Please note that changing this value may affect the usability of the respective content.
function Interface.setLighting(systemcolor, windowcolor, controlcolor, contentcolor)
end

---Sets the text of a string resource.
---@param id string String resource ID
---@param text string Text to store in the string resource
function Interface.setString(id, text)
end
...
function Interface.toggleWindow(windowclass, datasource)
end
