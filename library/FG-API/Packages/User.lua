...
function User.createLocalIdentity()
end
...
function User.getActiveIdentities(username)
end
...
function User.getCurrentIdentity(username)
end
...
function User.getCurrentIdentityColors()
end
...
function User.getIdentityColor(identity)
end
...
function User.getIdentityLabel(identityname)
end
...
function User.getIdentityOwner(identityname)
end
...
function User.getLocalIdentities()
end
...
function User.getLocalIdentityPortrait(identityroot)
end

---Get the list of identity names owned by this client.
---@return string[] # An integer indexed table containing string values representing the identities in use
function User.getOwnedIdentities()
end
...
function User.getPortraitDirectoryList()
end
...
function User.getPortraitFileList()
end
...
function User.isOwnedIdentity(identityname, username)
end
...
function User.onIdentityActivation(identityname, username, activated)
end
...
function User.onIdentityStateChange(identityname, username, statename, state)
end
...
function User.onLogin(username, activated)
end
...
function User.onUserStateChange(username, statename, state)
end
...
function User.releaseIdentity(identityname)
end
...
function User.requestIdentity(identity_id, second, third, import_node, resultcallback)
end
...
function User.ringBell(username)
end
...
function User.setCurrentIdentity(identityname)
end
...
function User.setCurrentIdentityColors(color, blacktext)
end
...
---@param identityroot databasenode
---@return string # A string identifying the currently set portrait. This value should only be used to pass to other portrait elements using functions such as portraitselectioncontrol.setFile
function User.setLocalIdentityPortrait(identityroot)
end
...
function User.setPortrait(identity, portraitfile)
end

function User.addEventHandler()
end

function User.getCurrentIdentityDiceColors()
end

function User.getDiceVolume()
end

function User.setCurrentIdentityDiceColors()
end

function User.setDiceVolume()
end
