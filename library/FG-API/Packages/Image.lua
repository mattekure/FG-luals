...
function Image.addLayer(dbnodeORdbpath, layertype, layerdata)
end
...
---@return number|nil # Returns the layer ID of the created layer, or nil if no layer created.
function Image.addLayerPaintStamp(dbnodeORdbpath, layerid, stampdata)
end
...
function Image.deleteLayer(dbnodeORdbpath, layerid)
end
...
function Image.getDistanceBaseUnits(dbnodeORdbpath)
end
...
function Image.getDistanceBetween(dbnodeORdbpath, tokena, tokenb)
end
...
function Image.getDistanceDiagMult(dbnodeORdbpath)
end
...
function Image.getDistanceSuffix(dbnodeORdbpath)
end
...
function Image.getGridOffset(dbnodeORdbpath)
end
...
function Image.getGridSize(dbnodeORdbpath)
end
...
function Image.getGridSnap(dbnodeORdbpath)
end
...
function Image.getGridType(dbnodeORdbpath)
end
...
function Image.getLayerByName(dbnodeORdbpath, name)
end
...
function Image.getSize(dbnodeORdbpath)
end
...
function Image.getTokenLockState(dbnodeORdbpath)
end
...
function Image.getTokens(dbnodeORdbpath)
end
...
---@return table # A table with integer index values containing references to tokeninstance objects.
function Image.getTokensWithinDistance(dbnodeORdbpath, token, distance)
end
...
function Image.hasGrid(dbnodeORdbpath)
end
...
function Image.hasTokens(dbnodeORdbpath)
end
...
function Image.isImage(dbnodeORdbpath)
end
...
function Image.setDistanceBaseUnits(dbnodeORdbpath, units)
end
...
function Image.setDistanceDiagMult(dbnodeORdbpath, multiplier)
end
...
function Image.setDistanceSuffix(dbnodeORdbpath, suffix)
end
...
function Image.setGridOffset(dbnodeORdbpath, offsetx, offsety)
end
...
function Image.setGridSize(dbnodeORdbpath, size)
end
...
function Image.setGridSnap(dbnodeORdbpath, snapenable)
end
...
function Image.setGridType(dbnodeORdbpath, type)
end
...
function Image.setTokenLockState(dbnodeORdbpath, state)
end
...
function Image.snapToGrid(dbnodeORdbpath, x, y)
end

function Image.addLayerPaintStroke()
end

function Image.getDrawLockState()
end

function Image.setDrawLockState()
end
