...
function Utility.decodeCSV(xmlstring)
end
...
---@return table # An internal Lua table format for XML
function Utility.decodeJSON(xmlstring)
end
...
function Utility.decodeURL(urlstring)
end
...
function Utility.encodeCSV(xmltable)
end
...
function Utility.encodeJSON(xmltable)
end
...
function Utility.encodeURL(string)
end
