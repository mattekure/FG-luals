...
function Token.getDistanceBetween(tokena, tokenb)
end
...
function Token.addEventHandler()
end

function Token.removeEventHandler()
end

function Token.addToken()
end

function Token.approvePlannedMovement()
end

function Token.approvePlannedMovementAll()
end

function Token.cancelPlannedMovement()
end

function Token.cancelPlannedMovementAll()
end

function Token.getOwner()
end

function Token.getPlannedMovementDistance()
end

function Token.hasPlannedMovement()
end

function Token.isOwner()
end

function Token.setOwner()
end
