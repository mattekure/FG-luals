...
---@param name string The name of the module being targeted by the operation
function Module.deactivate(name)
end
...
function Module.export(parametertable)
end
...
function Module.getModuleInfo(lookupname)
end
...
function Module.onActivationRequested(name)
end
...
---@param name string The name of the module causing the event
function Module.onModuleAdded(name)
end

---This event is fired when a module is loaded.
---@param name string The name of the module causing the event
function Module.onModuleLoad(name)
end
...
---@param name string The name of the module causing the event
function Module.onModuleRemoved(name)
end

---This event is fired when a module is unloaded.
---@param name string The name of the module causing the event
function Module.onModuleUnload(name)
end
...
---@param name string The name of the module causing the event
function Module.onModuleUpdated(name)
end
...
function Module.setModulePermissions(name, allow)
end

function Module.addEventHandler()
end

function Module.removeEventHandler()
end
